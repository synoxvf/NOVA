...
New-Item -Path "$env:TEMP\enableReg\disable1.reg" -Value $file1 -Force | Out-Null
New-Item -Path "$env:TEMP\enableReg\disable2.reg" -Value $file2 -Force | Out-Null
New-Item -Path "$env:TEMP\enableReg\disable3.reg" -Value $file3 -Force | Out-Null
New-Item -Path "$env:TEMP\enableReg\disable4.reg" -Value $file4 -Force | Out-Null
New-Item -Path "$env:TEMP\enableReg\disable5.reg" -Value $file5 -Force | Out-Null
